...
use App\Support\Import\ProductRules;
...
final class ProductController extends Controller
{
    ...
    {
        // The rule array itself lives in `ProductRules` so the CSV importer validates a row exactly
        // as this form does (BAN-491). An import that validated more loosely would be a second,
        // quieter way into the catalogue.
        $data = $request->validate(ProductRules::forValidator($creating));

        ProductRules::assertReferencesAreOurs($data);
