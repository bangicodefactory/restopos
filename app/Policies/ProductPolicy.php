...
final class ProductPolicy
{
    ...
    {
        return $this->sameCompany($user, $product->company_id) && $this->userCan($user, 'config.view');
    }
    ...
    {
        return $this->sameCompany($user, $product->company_id) && $this->userCan($user, 'config.manage');
    }
